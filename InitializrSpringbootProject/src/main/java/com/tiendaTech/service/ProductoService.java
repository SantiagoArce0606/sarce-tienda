...
import com.tiendaTech.repository.ProductoRepository;
...
public class ProductoService {
    ...
    @Transactional(readOnly = true)
    public List<Producto> consultaPorDescripcionJPQL(String descripcion) {
        return productoRepository.consultaPorDescripcionJPQL(descripcion);
    }
}